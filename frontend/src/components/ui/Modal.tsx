        ...
        <div className="flex min-h-full items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <div className="flex items-start justify-between border-b border-border/60 px-5 py-4 sm:px-6">
              <div>
                <h2 id={titleId} className="text-[16px] font-bold tracking-tight text-foreground leading-tight">
                  {title}
                </h2>
                {description && (
              ...
              <button
                ...
                onClick={onClose}
                aria-label="Fermer"
                className="ml-4 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-muted-foreground transition-all hover:bg-muted hover:text-foreground"
              >
